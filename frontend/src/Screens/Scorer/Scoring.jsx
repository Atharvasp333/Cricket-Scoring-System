...
//             handleStartInnings(battingTeamIndex);
//           } else {
...
//         console.log('Match is upcoming, checking for setup parameters');
...
//           console.log('Found setup parameters in URL, using them to initialize match');
//           // If we have URL parameters, automatically start the match with the selected team
//           const battingTeamIndex = data.team1_players.some(p => p.name === urlParams.get('striker')) ? 0 : 1;
//           // We need to set matchData first before calling handleStartInnings
//           setTimeout(() => handleStartInnings(battingTeamIndex), 0);
//         } else {
//           // If no URL parameters, show the start innings modal
//           setUiState(prev => ({ ...prev, showStartInningsModal: true }));
//         }
...
//           // If loading fails, check for URL parameters
//           const urlParams = new URLSearchParams(window.location.search);
//           const hasSetupParams = urlParams.has('striker') && urlParams.has('nonStriker') && urlParams.has('bowler');
