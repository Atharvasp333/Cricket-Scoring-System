...
const MatchDetails = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            {/* Match Header */}
            <section className="bg-[#16638A] text-white py-6 px-4">
                <div className="container mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <div className="flex items-center mb-4 md:mb-0">
                            <div className="text-center mr-6">
                                <div className="text-2xl font-bold">{matchData.team1.name}</div>
                                <div className="text-xl">{matchData.team1.score}</div>
                            </div>
                            <div className="text-2xl font-bold mx-4">vs</div>
                            <div className="text-center ml-6">
                                <div className="text-2xl font-bold">{matchData.team2.name}</div>
                                <div className="text-xl">{matchData.team2.score}</div>
                            </div>
                        </div>
                        <div className="text-center md:text-right">
                            <div className="text-lg font-bold">{matchData.status}</div>
            ...
            <section className="py-8 px-4 bg-white">
                <div className="container mx-auto">
                    <div className="h-40 flex items-center justify-center bg-gray-100 rounded-lg relative overflow-hidden">
                        {currentAnimation ? (
                            <div className="animate-bounce text-6xl font-bold">
                            ...
                            <div className="text-gray-400 text-xl">Live ball updates will appear here</div>
                        )}
                    </div>
                </div>
            </section>
            ...
            <section className="py-4 px-4 bg-gray-100">
                <div className="container mx-auto">
                    <div className="bg-white rounded-lg p-4 shadow-sm">
                        ...
                        {matchData.team1.score.includes('/') && matchData.team2.score.includes('/') && (
                            <div className="text-center">
                                <p className="text-[#16638A] font-medium">
                                    {matchData.status}
                                </p>
                            </div>
                        )}
