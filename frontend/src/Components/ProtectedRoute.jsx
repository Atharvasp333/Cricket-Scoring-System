...
//       allowedRoles
//     });
//   }, [currentUser, userRole, loading, allowedRoles]);
...
//   // Get role from context or sessionStorage as fallback
//   const effectiveRole = userRole || sessionStorage.getItem('userSignupRole') || 'viewer';
  
//   if (allowedRoles.length > 0 && !allowedRoles.includes(effectiveRole)) {
//     switch (effectiveRole) {
//       case 'scorer':
//         return <Navigate to="/scorer-home" replace />;
//       case 'organiser':
//         return <Navigate to="/organiser-homepage" replace />;
//       case 'viewer':
//       default:
...
const ProtectedRoute = ({ children, allowedRoles = [] }) => {
  ...
  const effectiveRole = userRole || localStorage.getItem('userRole') || 'viewer';
