...
const { Button, Input, LoadingSpinner } = Components;
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input
                ...
                name="remember-me"
                type="checkbox"
                className="h-4 w-4 text-[#16638A] focus:ring-[#16638A] border-gray-300 rounded"
              />
            ...
            <div className="text-sm">
              <button
                ...
                className="font-medium text-[#16638A] hover:text-[#0f4c6a]"
              >
